...
CSV_LOCAL = "LISTA_MAESTRA_FINAL.csv"       # Archivo local opcional (NASDAQ/NYSE)
...
def obtener_tickers():
    ...
    if tickers_csv:
        ...
        return tickers_csv, "companylist.csv"
    ...
    if tickers_sp500:
        ...
        return tickers_sp500, "S&P 500 (Wikipedia)"
    ...
    return emergencia, "Lista de emergencia"
...
def ejecutar_criba():
    ...
    # --- Cargar tickers ---
    tickers, fuente = obtener_tickers()
